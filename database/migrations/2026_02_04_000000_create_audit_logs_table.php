...
class CreateAuditLogsTable extends Migration
{
    public function up()
    {
        Schema::create('audit_logs', function (Blueprint $table) {
            ...
            $table->text('details')->nullable(); // JSON or text description (Era)
            $table->text('description')->nullable(); // Keuangan compatibility
            $table->string('ip_address')->nullable();
            $table->string('user_agent')->nullable(); // Keuangan compatibility
            $table->timestamps();
        });
    }
