...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['role:admin'])->group(function () {
        ...
        // Cleanup Routes
        Route::post('/settings/cleanup/mapels', [App\Http\Controllers\CleanupController::class, 'removeWrongJenjangMapels'])->name('cleanup.mapel.mismatch');
        Route::post('/settings/cleanup/grades', [App\Http\Controllers\CleanupController::class, 'removeWrongJenjangGrades'])->name('cleanup.grades.mismatch');
        ...
        Route::post('/settings/desktop-integration', [App\Http\Controllers\SettingsController::class, 'updateDesktopConfig'])->name('settings.desktop.update');
        ...
        // Jenjang Management
        Route::get('settings/jenjang', [App\Http\Controllers\JenjangController::class, 'index'])->name('settings.jenjang.index');
        Route::post('settings/jenjang', [App\Http\Controllers\JenjangController::class, 'store'])->name('settings.jenjang.store');
        Route::get('settings/jenjang/{id}/settings', [App\Http\Controllers\JenjangController::class, 'settings'])->name('settings.jenjang.settings');
        Route::post('settings/jenjang/{id}/settings', [App\Http\Controllers\JenjangController::class, 'updateSettings'])->name('settings.jenjang.updateSettings');
        Route::delete('settings/jenjang/{id}', [App\Http\Controllers\JenjangController::class, 'destroy'])->name('settings.jenjang.destroy');
        ...
        Route::post('/classes/{class}/remove-student/{studentId}', [App\Http\Controllers\ClassroomController::class, 'removeStudent'])->name('classes.remove-student');
        ...
        Route::post('/classes/{class}/move-students', [App\Http\Controllers\ClassroomController::class, 'moveStudents'])->name('classes.move-students');
    ...
    Route::middleware(['role:staff_tu,admin,teacher,bendahara,staf_keuangan'])->prefix('tu')->group(function () {
        Route::get('/dashboard', [App\Http\Controllers\TuController::class, 'index'])->name('tu.dashboard')->middleware('role:staff_tu,admin,bendahara,staf_keuangan'); // Dashboard restricted
...
// (Moved)
    ...
    Route::middleware(['role:teacher,admin'])->prefix('wali-kelas')->group(function () {
        ...
        Route::post('/kenaikan-kelas/lock', [App\Http\Controllers\WaliKelasController::class, 'lockClass'])->name('walikelas.kenaikan.lock');
        Route::post('/kenaikan-kelas/unlock', [App\Http\Controllers\WaliKelasController::class, 'unlockClass'])->name('walikelas.kenaikan.unlock');

        // Admin Promotion Routes (Redirected to WaliKelas View)
        // Kept named routes for compatibility but point to WaliKelasController
        Route::get('/promotion', [App\Http\Controllers\WaliKelasController::class, 'kenaikanKelas'])->name('promotion.index');
        Route::post('/promotion/update', [App\Http\Controllers\WaliKelasController::class, 'storeKenaikanKelas'])->name('promotion.update'); // Partial mapping
        ...
        // Route::post('/promotion/process', [App\Http\Controllers\PromotionController::class, 'processPromotion'])->name('promotion.process'); // Deprecated?
        // Route::post('/promotion/process-all', [App\Http\Controllers\PromotionController::class, 'processAll'])->name('promotion.process_all'); // Deprecated
        // Route::post('/promotion/finalize', [App\Http\Controllers\PromotionController::class, 'finalize'])->name('promotion.finalize'); // Deprecated
