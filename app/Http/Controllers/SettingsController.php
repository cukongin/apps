...
class SettingsController extends Controller
{
    ...
    {
        $request->validate([
            'role' => 'required|in:admin,teacher,student,staff_tu,bendahara,staf_keuangan'
        ]);
    ...
    {
        $wa_api_url = \App\Models\GlobalSetting::val('wa_api_url', 'https://api.fonnte.com/send');
        $wa_api_token = \App\Models\GlobalSetting::val('wa_api_token', '');
        $wa_payment_template = \App\Models\GlobalSetting::val('wa_payment_template');
        $wa_mode = \App\Models\GlobalSetting::val('wa_mode', 'api');
    ...
    public function updateWhatsapp(Request $request)
    {
        ...
        \App\Models\GlobalSetting::set('wa_mode', $request->wa_mode);
        \App\Models\GlobalSetting::set('wa_api_url', $request->wa_api_url);
        \App\Models\GlobalSetting::set('wa_api_token', $request->wa_api_token);
        \App\Models\GlobalSetting::set('wa_payment_template', $request->wa_payment_template);
    ...
    public function testWhatsapp(Request $request)
    {
        ...
        $mode = \App\Models\GlobalSetting::val('wa_mode', 'api');
        ...
        // API Mode
        $result = \App\Keuangan\Services\WhatsAppService::send($request->target, $message);
    ...
    public function storeUser(Request $request)
    {
        $request->validate([
            ...
            'role' => 'required|string|in:admin,admin_utama,kepala_madrasah,pengawas,bendahara,teller_tabungan,staf_keuangan,staf_administrasi,teacher,staff_tu',
    ...
    // --- Finance Settings Specialized View ---

    public function financeIndex()
    {
        $users = \App\Models\User::orderBy('name')->get();

        // Fetch System Identity Settings (Using GlobalSetting wrapper)
        $setting = [
            'nama_sistem' => \App\Models\GlobalSetting::val('nama_sistem', 'Sistem Pesantren'),
            'alamat' => \App\Models\GlobalSetting::val('alamat', ''),
            'no_telp' => \App\Models\GlobalSetting::val('no_telp', ''),
            'logo' => \App\Models\GlobalSetting::val('app_logo', null), // Map 'logo' to 'app_logo'
        ];
