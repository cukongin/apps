...
class TeacherDashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        // Sort assignments by Class Name then Mapel Name
        ...
        foreach ($assignments as $asg) {
            ...
            // Group by Class Name
            $classProgress[$asg->kelas->nama_kelas][] = $classData;
        }

        $totalClasses = $assignments->count(); // Recalculate if needed, but count is same
    ...
    public function inputNilai(Request $request, $kelasId, $mapelId)
    {
        ...
        $gradingSettings = \App\Models\Jenjang::getSettings($jenjang);
    ...
    public function storeNilai(Request $request)
    {
        ...
        $settings = \App\Models\Jenjang::getSettings($activeJenjang);
