...
class ReportController extends Controller
{
    ...
    public function classAnalytics(Request $request, $classId)
    {
        ...
        // Role Model Logic: Top 20 Rankers who are NOT Anomalies AND have Low Alpha (Under 10)
        // Condition: Rank <= 20 AND Alpha < 10 (Matches Anomaly Threshold)
