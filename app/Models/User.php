...
class User extends Authenticatable
{
    ...
    public function isStafKeuangan()
    {
        return $this->role === 'staf_keuangan';
    }

    public function isStafAdministrasi()
    {
        return $this->role === 'staf_administrasi';
    }
    ...
    {
        return $this->role === 'teller_tabungan';
    }
}
