...
<div class="flex flex-col gap-6">
    ...
    <div class="card-boss !p-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex flex-col md:flex-row gap-2 w-full md:w-auto">
             <a href="{{ route('walikelas.leger.rekap.export') }}" target="_blank" class="btn-boss bg-emerald-600 hover:bg-emerald-700 text-white shadow-lg shadow-emerald-600/20 px-4 py-2.5 flex items-center justify-center gap-2 w-full md:w-auto">
