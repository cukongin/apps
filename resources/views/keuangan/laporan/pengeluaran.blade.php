    ...
    <div class="block print:break-before-page mt-8 w-full print:mt-2">
        ...
        <div class="bg-white dark:bg-[#1a2e1d] rounded-xl shadow-sm border border-[#dbe6dd] dark:border-[#2a3a2d] p-6 print:border-none print:shadow-none print:p-0">
            ...
            @foreach($groupedPengeluarans as $category => $items)
                @foreach($items as $item)
                    @if($item->bukti_foto)
                        <div class="bg-white border border-gray-200 print:border-black p-2 rounded-lg shadow-sm print:shadow-none print:rounded-none flex flex-col break-inside-avoid print:h-[11.6cm] print:p-0">
                            <!-- Image Container -->
                            ...
                            <!-- Keterangan -->
                            <div class="text-xs border-t border-gray-100 print:border-black pt-1 bg-white z-10 print:text-[10pt] print:px-2 print:pb-2">
