<x-app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="flex justify-between mb-4">
                        <h3 class="text-lg font-bold">Daftar Kategori Pemasukan</h3>
                            ...
                            @foreach ($kategoris as $kategori)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        ...
                                        <form action="{{ route('keuangan.kategori-pemasukan.destroy', $kategori->id) }}" method="POST" class="inline-block" onsubmit="return confirm('Yakin ingin menghapus kategori ini?');">
                                            @csrf
                                            @method('DELETE')
    ...
    <div id="createModal" class="fixed z-10 inset-0 overflow-y-auto hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <form action="{{ route('keuangan.kategori-pemasukan.store') }}" method="POST">
                    @csrf
    ...
    <script>
        function editKategori(id, nama, deskripsi) {
            ...
            document.getElementById('editForm').action = "{{ route('keuangan.kategori-pemasukan.update', '') }}/" + id;
