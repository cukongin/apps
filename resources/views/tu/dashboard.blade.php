...
<div class="flex-1 flex flex-col h-full overflow-hidden relative">
    ...
    <!-- Header -->
    <header class="hidden lg:flex items-center justify-between px-8 py-5 bg-white/50 dark:bg-slate-900/50 backdrop-blur-xl border-b border-slate-200/50 dark:border-slate-700/50 sticky top-0 z-10">
        <div>
        ...
        <div class="flex items-center gap-4">
            <div class="flex items-center gap-3 pl-2">
                <div class="bg-center bg-no-repeat bg-cover rounded-full size-10 border-2 border-white dark:border-slate-700 shadow-sm flex items-center justify-center bg-gradient-to-br from-primary to-primary-dark text-white uppercase font-bold text-lg">
    ...
    <!-- Content -->
    <div class="flex-1 overflow-y-auto px-4 lg:px-8 pb-10 scroll-smooth custom-scrollbar">
        <div class="max-w-7xl mx-auto flex flex-col gap-8 pt-6">
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div class="flex flex-col gap-2">
                    <h2 class="text-3xl font-bold text-slate-900 dark:text-white tracking-tight flex items-center gap-2">
                        Halo, {{ auth()->user()->name }}
                        <span class="material-symbols-outlined text-amber-500 animate-pulse text-3xl">waving_hand</span>
                    </h2>
                ...
                <div class="flex items-center gap-2">
                    <a href="{{ route('tu.monitoring.global') }}" class="btn-boss btn-primary flex items-center gap-2 shadow-lg shadow-primary/30">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <!-- Total Siswa -->
                <div class="card-boss relative overflow-hidden group !p-6">
                ...
                <!-- Tahun Ajaran -->
                <div class="bg-gradient-to-br from-primary to-primary-dark text-white p-6 rounded-2xl shadow-lg shadow-primary/20 relative overflow-hidden transition-transform hover:scale-[1.02]">
                ...
                <div class="w-full flex flex-col gap-8">
                    <div class="flex items-center justify-between">
                        ...
                        <form action="{{ route('tu.dashboard') }}" method="GET" class="flex items-center gap-2">
                            ...
                            <div class="relative">
                                <select name="angkatan_id" onchange="this.form.submit()" class="input-boss !py-1.5 !text-xs !pl-3 !pr-8 bg-white dark:bg-slate-800">
                    ...
                    <div class="card-boss !p-6 flex flex-col relative z-20 min-h-[500px]">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10 pt-4">
                        ...
                        <div class="bg-gradient-to-br from-primary to-primary-dark rounded-xl p-4 text-white shadow-lg shadow-primary/20 relative overflow-hidden group transition-transform hover:scale-[1.02]">
                        ...
                        <div class="bg-gradient-to-br from-secondary to-primary rounded-xl p-4 text-white shadow-lg shadow-primary/20 relative overflow-hidden group transition-transform hover:scale-[1.02]">
                            <div class="absolute top-0 right-0 p-3 opacity-20">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 pt-4">
                        ...
                        <div class="card-boss !p-6 flex flex-col items-center justify-center">
